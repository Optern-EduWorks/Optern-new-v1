...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        Title = "Optern API",
        Version = "v1",
        Description = "A comprehensive API for the Optern application",
        Contact = new Microsoft.OpenApi.Models.OpenApiContact
        {
            Name = "Optern Team",
            Email = "support@optern.com"
        }
    });
...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "OpternAPI";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "OpternFrontend";
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        if (!context.Users.Any(u => u.Role == "Admin"))
        {
            ...
            Console.WriteLine("Default admin user created: admin@optern.com / Admin123!");
        }
    }
    catch (Exception ex)
    {
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Optern API v1");
    options.RoutePrefix = "swagger"; // Access at /swagger
    options.DocumentTitle = "Optern API Documentation";
});
